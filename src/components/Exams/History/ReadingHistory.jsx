...
export default function ReadingHistory({ content, selectedAnswers }) {
    ...
    const handleAIExplanationClicked = async () => {
        const response = await getAIExplanationApi(content.questions);
    ...
    return (
        <div className="">
            ...
            {content.contentURL === "" ? null : (
                <audio className="m-auto" controls src={content.contentURL}></audio>
            )}
